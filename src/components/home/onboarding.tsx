      ...
      <DialogContent className="sm:max-w-[425px] font-sans">
        <DialogHeader>
          <DialogTitle className="font-sans">
            Welcome to Loop, {user?.user_metadata.name}!
          </DialogTitle>
          <DialogDescription className="font-mono">
            Let&apos;s get you started with Loop. Please fill out the following
            information.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder={`looper-${nanoid(3)}-${user?.user_metadata.full_name}`}
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Your name of choice.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
